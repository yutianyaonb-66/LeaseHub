...
import com.leo.leasahub.security.ajax_login.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Resource
    private UserDetailsService  leasahubUserDetailService;
...
//        auth.authenticationProvider(tokenAuthenticationProvider).eraseCredentials(true);
        auth.userDetailsService(leasahubUserDetailService).passwordEncoder(passwordEncoder);
    }
