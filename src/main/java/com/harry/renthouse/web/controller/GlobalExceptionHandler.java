package com.leo.leasahub.web.controller;
...
import org.springframework.web.multipart.MaYuploadSizeExceededException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = MaYuploadSizeExceededException.class)
    public ApiResponse fileSizeExceptionHandler(MaYuploadSizeExceededException e){
        log.error("文件上传大小超限:{}", e.getMessage());
        return ApiResponse.ofMessage(ApiResponseEnum.FILE_SIZE_EXCEED_ERROR.getCode(),
                MessageFormat.format(ApiResponseEnum.FILE_SIZE_EXCEED_ERROR.getMessage(), maYuploadSize));
    }
