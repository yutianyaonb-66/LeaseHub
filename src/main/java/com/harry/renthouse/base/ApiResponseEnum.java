...
public enum ApiResponseEnum {
    ...
    USER_ALREADY_EXIST(40010, "用户已存在"),
    ...
    HOUSE_SUBSCRIBE_CANCEL_FINISH_ERROR(500224, "取消预约失败,该预约已完成"),

    HOUSE_UN_STAR_NOT_FOUND_ERROR(500227, "未收藏该房源"),
    HOUSE_STAR_REPEAT_ERROR(500227, "不可重复收藏房源"),
    // 短信相关
